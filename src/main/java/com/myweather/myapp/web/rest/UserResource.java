...
import com.myweather.myapp.service.MailService;
...
import com.myweather.myapp.web.rest.errors.EmailAlreadyUsedException;
import com.myweather.myapp.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <li> As this manages users, for security reasons, we'd rather have aResponseEntity DTO layer.</li>
 * </ul>
 * <p>
