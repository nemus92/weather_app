...
import com.myweather.myapp.config.audit.AuditEventConverter;
import com.myweather.myapp.domain.PersistentAuditEvent;
...
import static com.myweather.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
